...
class ArcheanProfilerAnalyzer:
    def __init__(self, root):
        ...
        self.build_menu()
        self.sort_column = 'Avg'  # Default sorting by 'Avg'
        self.sort_reverse = False
        self.filter_text = ''

    def create_widgets(self):
        # Create a frame to hold the Treeview, scrollbar, and buttons
        ...
        # Create buttons for "Expand All" and "Collapse All"
    ...
    def populate_treeview(self):
        ...
        self.tree.tag_configure('bad', background='light salmon')
...
def main():
    root = tk.Tk()
    app = ArcheanProfilerAnalyzer(root)
    root.mainloop()
